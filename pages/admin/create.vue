  ...
  <ElForm label-position="top" @submit="onSubmit">
    <ElRow :gutter="20">
      <ElCol :xs="24" :xl="16">
        ...
        <AdminInput name="description" type="textarea" label="Description" :autosize="{ minRows: 4 }" />
        <AdminSelect
          :options="
            languages.map((i) => ({
              label: i,
        ...
        <AdminUpload name="template_file" label="Upload template file" :accept="['docx', 'mp4']" class="mb-6" />
