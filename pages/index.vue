  ...
  <div class="bg-white py-20 sm:py-28">
    <div class="mx-auto max-w-7xl px-6 lg:px-8">
      <div class="mx-auto max-w-2xl lg:text-center">
        <h2 class="text-base font-medium leading-7 text-sky-600">Deploy faster</h2>
        <p class="mt-2 text-3xl font-bold tracking-tight text-neutral-950 sm:text-4xl">
      ...
      <div class="mx-auto mt-16 max-w-2xl sm:mt-20 lg:mt-24 lg:max-w-4xl">
        ...
        >
          <div v-for="feature in features" :key="feature.name" class="relative pl-16">
            <dt class="text-base font-medium leading-7 text-neutral-950">
              <div
