...
<template>
  ...
  >
    <ElScrollbar wrap-class="sidebar-scrollbar__wrap">
      <ElMenu ref="sidebarMenu" class="sidebar-menu" :collapse="store.collapse" :collapse-transition="false" router>
            ...
            <template v-for="(subMenuItem, subMenuIndex) in menuItem.children">
              ...
              >
                ...
                <ElMenuItem
                  ...
                  :class="{
                    'is-active': route.path === subSubMenuItem.path,
                  }"
                >
              ...
              <ElMenuItem
                ...
                :class="{
                  'is-active': route.path === subMenuItem.path,
                }"
              >
                <template #title>{{ subMenuItem.label }}</template>
              </ElMenuItem>
