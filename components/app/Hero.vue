...
<template>
  <div class="z-hero relative flex h-56 w-full items-center justify-center py-32 sm:h-60 md:h-64 lg:h-72 xl:h-80">
    <img
      :src="heroImage"
    ...
    <BaseContainer class="relative z-[3] w-full text-white">
      <span class="line-clamp-2 block text-3xl font-medium uppercase !leading-snug sm:text-4xl lg:text-5xl">
