<template>
  <div class="py-4 flex flex-col justify-center items-center text-lg">
    <div class="mx-auto">
      <svg class="w-[96px] h-[61.5px] md:w-[128px] md:h-[82px]" viewBox="0 0 64 41">
    ...
    <p class="font-semibold uppercase mt-2">
      No Data Found
    </p>
  </div>
</template>
