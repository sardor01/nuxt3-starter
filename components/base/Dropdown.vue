...
<template>
  ...
  >
    <BaseButton custom left :class="triggerClass" @click="mode === 'click' ? handleToggle() : () => {}">
      ...
      >
        ...
        <template v-if="items.length">
          <ul
            ...
            :class="itemsClass"
          >
            <li v-for="(item, i) of subItems" :key="i" role="menuitem" :class="itemClass" @click="handleClose">
